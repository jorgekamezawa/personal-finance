...
## Comentário e idioma
- Código, identificador e comentário em inglês; texto que o usuário lê fica em português.
...
- O perfil `local` traz valor fixo, nunca variável de ambiente: ele existe para rodar na máquina sem preparar nada.
