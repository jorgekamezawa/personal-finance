...
1. **Nada de commit antes da validação.** Terminou de desenvolver, **pare** e mostre o que foi feito: o que mudou, a evidência de que funciona (comando e saída real) e o que ficou de fora. Só depois da aprovação explícita de Jorge vem `git commit`.
